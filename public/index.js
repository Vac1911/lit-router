(function (factory) {
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
    const t$2={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},i$2=t=>(...i)=>({_$litDirective$:t,values:i});class s$2{constructor(t){}T(t,i,s){this.Σdt=t,this.M=i,this.Σct=s;}S(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}

    /**
     * @license
     * Copyright 2020 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const{et:t$1}=Z,i$1=o=>null===o||"object"!=typeof o&&"function"!=typeof o,n$3={HTML:1,SVG:2},v$1=(o,t)=>{var i,n;return void 0===t?void 0!==(null===(i=o)||void 0===i?void 0:i._$litType$):(null===(n=o)||void 0===n?void 0:n._$litType$)===t},l$3=o=>{var t;return void 0!==(null===(t=o)||void 0===t?void 0:t._$litDirective$)},r$3=o=>{var t;return null===(t=o)||void 0===t?void 0:t._$litDirective$},d$2=o=>void 0===o.strings,e$2=()=>document.createComment(""),u$1=(o,i,n)=>{var v;const l=o.A.parentNode,r=void 0===i?o.B:i.A;if(void 0===n){const i=l.insertBefore(e$2(),r),v=l.insertBefore(e$2(),r);n=new t$1(i,v,o,o.options);}else {const t=n.B.nextSibling,i=n.M!==o;if(i&&(null===(v=n.Q)||void 0===v||v.call(n,o),n.M=o),t!==r||i){let o=n.A;for(;o!==t;){const t=o.nextSibling;l.insertBefore(o,r),o=t;}}}return n},c$2=(o,t,i=o)=>(o.I(t,i),o),s$1={},f$1=(o,t=s$1)=>o.H=t,a$1=o=>o.H,m$1=o=>{var t;null===(t=o.P)||void 0===t||t.call(o,!1,!0);let i=o.A;const n=o.B.nextSibling;for(;i!==n;){const o=i.nextSibling;i.remove(),i=o;}},p$1=o=>{o.R();};

    /**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const r$2=(i,t)=>{var s,e;const o=i.N;if(void 0===o)return !1;for(const i of o)null===(e=(s=i).O)||void 0===e||e.call(s,t,!1),r$2(i,t);return !0},o=i=>{let t,s;do{if(void 0===(t=i.M))break;s=t.N,s.delete(i),i=t;}while(0===(null==s?void 0:s.size))},h$1=i=>{for(let t;t=i.M;i=t){let s=t.N;if(void 0===s)t.N=s=new Set;else if(s.has(i))break;s.add(i),d$1(t);}};function n$2(i){void 0!==this.N?(o(this),this.M=i,h$1(this)):this.M=i;}function l$2(i,t=!1,s=0){const e=this.H,h=this.N;if(void 0!==h&&0!==h.size)if(t)if(Array.isArray(e))for(let i=s;i<e.length;i++)r$2(e[i],!1),o(e[i]);else null!=e&&(r$2(e,!1),o(e));else r$2(this,i);}const d$1=i=>{var t,e,r,o;i.type==t$2.CHILD&&(null!==(t=(r=i).P)&&void 0!==t||(r.P=l$2),null!==(e=(o=i).Q)&&void 0!==e||(o.Q=n$2));};class c$1 extends s$2{constructor(){super(...arguments),this.isConnected=!0,this.ut=w$1,this.N=void 0;}T(i,t,s){super.T(i,t,s),h$1(this);}O(i,t=!0){this.at(i),t&&(r$2(this,i),o(this));}at(t){var s,e;t!==this.isConnected&&(t?(this.isConnected=!0,this.ut!==w$1&&(this.setValue(this.ut),this.ut=w$1),null===(s=this.reconnected)||void 0===s||s.call(this)):(this.isConnected=!1,null===(e=this.disconnected)||void 0===e||e.call(this)));}S(i,t){if(!this.isConnected)throw Error(`AsyncDirective ${this.constructor.name} was rendered while its tree was disconnected.`);return super.S(i,t)}setValue(i){if(this.isConnected)if(d$2(this.Σdt))this.Σdt.I(i,this);else {const t=[...this.Σdt.H];t[this.Σct]=i,this.Σdt.I(t,this,0);}else this.ut=i;}disconnected(){}reconnected(){}}
    ...
    */
    ...
    class ArticleCard extends h$2 {
        ...
        get createdAtRelative() {
            return this.createdAt ? T`${DateTime.fromSeconds(this.createdAt).toRelative()}` : '-'
        }
        ...
        render() {
            ...
            <div class="card-body">
                ...
                <div class="mt-auto">
                    ${this.id ? T`<router-link href="/articles/${this.id}">Continue Reading</router-link>` : ''}
                </div>
            </div>
    ...
    class ArticleList extends h$2 {
        ...
        render() {
            ...
            for (let i = 0; i < this.count; i++) {
                if(this.articles[i]) itemTemplates.push(T`<article-card .id="${this.articles[i].id}" .title="${this.articles[i].title}" .createdAt="${this.articles[i].created_at}"></article-card>`);
                else itemTemplates.push(T`<article-card></article-card>`);
            }
            return T`<div class="wrapper">
            ${itemTemplates}
        </div>`;
